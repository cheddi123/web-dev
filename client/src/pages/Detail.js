				...
				<Container>
					<Row>
						<Col size="md-12">
							<h1 style={{ color: 'whitesmoke' }}>
								{topic} by {author} created at <span className="text-success"> {this.state.time}</span>
							</h1>
						</Col>
					</Row>
					...
					<Row className="">
						<Col size="md-10 md-offset-1">
							<article>
								<span style={{ color: 'red', fontSize: '30px' }}> Synopsis :</span>
								<span className="font-italic font-weight-bold p-2  ">{synopsis}</span>
							</article>
						</Col>
					</Row>
